    ...
    ListNode addTwoNumbers(ListNode l1, ListNode l2, int carry)
    {
        ...
        else
        {
            ...
            else if(l1 == null)
            {
                ...
                {
                    l2.val -= 10;
                    l2.next = addTwoNumbers(l1, l2.next, 1);
                    return l2;
                }
            }
            else if(l2 == null) return addTwoNumbers(l2, l1, carry);
            else
            {
                l1.val += l2.val + 1;
                if(l1.val < 10) l1.next = addTwoNumbers(l1.next, l2.next, 0);
                else
                {
                    l1.val -= 10;
                    l1.next = addTwoNumbers(l1.next, l2.next, 1);
                }
                return l1;
            }
        }
